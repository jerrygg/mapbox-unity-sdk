...
namespace Mapbox.Unity.MeshGeneration.Modifiers
{
	...
	[CreateAssetMenu(menuName = "Mapbox/Modifiers/Building Prefab Modifier")]
	public class BuildingPrefabModifier : GameObjectModifier
	{
		[SerializeField]
		private List<GameObject> _prefabList;

		[SerializeField]
		private string _buildingHeightKey;
